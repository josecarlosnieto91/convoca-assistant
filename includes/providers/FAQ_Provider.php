<?php
/**
 * FAQ Provider: indexes convoca_faq custom post type.
 *
...
/**
 * Provider for 'convoca_faq' custom post type.
 */
class FAQ_Provider extends Posts_Provider {
	...
	public function get_name(): string {
		return __( 'FAQ', 'convoca-assistant' );
	}
	...
	public function get_description(): string {
		return __( 'Preguntas frecuentes', 'convoca-assistant' );
	}
	...
	public function is_available(): bool {
		return post_type_exists( 'convoca_faq' );
	}
	...
	public function get_relations( int $entry_id ): array {
		$relations = array();
		$terms     = wp_get_post_terms( $entry_id, 'convoca_faq_cat', array( 'fields' => 'ids' ) );
